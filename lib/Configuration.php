...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://apis.splashifypro.com/api/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.1.0-dev/PHP';
    ...
    {
        $report  = 'PHP SDK (Splashifypro) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0' . PHP_EOL;
        $report .= '    SDK Package Version: 0.1.0-dev' . PHP_EOL;
