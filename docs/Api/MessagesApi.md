...
$body = array('key' => new \stdClass); // object | { message_id: string (our message_id of the inbound message; a WhatsApp wamid also works), to?: string (the contact's number; helps find an older message) }
