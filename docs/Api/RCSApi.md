...
$body = array('key' => new \stdClass); // object | { to, template_id, variables? }. variables: a list in {{1}}, {{2}} order, or an object keyed by number. 400 missing_variables / variable_too_long when a value is missing or too long.
